...
from .views import (
    join_live_session,
    create_live_session,
    create_recurring_live_sessions,
    cancel_live_session_series,
...
urlpatterns = [
    ...
    path("sessions/recurring/", create_recurring_live_sessions),
    path("sessions/series/<uuid:series_id>/cancel/", cancel_live_session_series),
    ...
    path("sessions/<uuid:session_id>/extend/", extend_live_session),
    path("sessions/<uuid:session_id>/end/", end_live_session),
    path("sessions/<uuid:session_id>/mute/", mute_live_participant),
    path("sessions/<uuid:session_id>/remove/", remove_live_participant),
    path("sessions/<uuid:session_id>/readmit/", readmit_live_participant),
    ...
    path("admin/streams/<uuid:session_id>/spectate/", admin_stream_spectate),
